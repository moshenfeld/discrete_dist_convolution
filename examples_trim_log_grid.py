...
"""
import numpy as np
from discrete_conv_api import DiscreteDist, Spacing, DistKind
...
X = DiscreteDist(x=x, kind=DistKind.PMF, vals=pmfX)
...
Y = DiscreteDist(x=y, kind=DistKind.CDF, vals=cdfY, p_neg_inf=0.01, p_pos_inf=0.01)
